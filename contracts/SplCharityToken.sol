...
contract SplCharityToken is ERC20 {
  ...
  function convertEthToToken(uint _tAmount, uint _deadline) public payable {

    uniswapRouter.swapETHForExactTokens{ value: msg.value }(_tAmount, getPathForETHtoToken(), address(this), _deadline);
